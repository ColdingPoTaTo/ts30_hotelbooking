...
import { CityCountyData } from "@/utils/CityCountyData"; //import CityCountyData from "@/assets/json/CityCountyData.json"; // import CityCountyData from "/public/json/CityCountyData";
type Area = {
  ZipCode: string;
  AreaName: string;
  AreaEngName: string;
